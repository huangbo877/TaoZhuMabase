 ...
 *
 */
public class NetworkImageHolderView implements
		CBPageAdapter.Holder<TzmFocusModel> {
	...
	@Override
	public void UpdateUI(final Context context, int position,
			final TzmFocusModel data) {
