...
public class RushBuyCountDownTimerViewWithDay extends LinearLayout {
	...
	public RushBuyCountDownTimerViewWithDay(Context context, AttributeSet attrs) {
		super(context, attrs);

		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View view = inflater.inflate(R.layout.day_view_countdowntimer, this);
	...
	public void setTime(long hours, long mins, long sec) {
		...
		if (hours > 59 || mins >= 60 || sec >= 60 || hours < 0 || mins < 0
				|| sec < 0) {
