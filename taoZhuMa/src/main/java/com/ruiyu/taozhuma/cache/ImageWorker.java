...
import com.ruiyu.taozhuma.cache.ImageCache.ImageCacheParams;
...
public enum ImageWorker {
	...
	private File downloadBitmap(String urlString) throws IOException {
		Log.e("Toby", "urlString:"+urlString);
		final DiskCache cache = DiskCache.openCache();

		if(cache==null){
			Log.e("Toby", "DiskCache is null:");
		}
		...
		final InputStream in = new BufferedInputStream(
				urlConnection.getInputStream(), ImageUtils.IO_BUFFER_SIZE);
