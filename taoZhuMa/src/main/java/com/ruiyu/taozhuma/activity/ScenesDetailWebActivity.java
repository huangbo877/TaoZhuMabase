...
/**
 * 
 * @author 林尧 2015-12-23 场景套餐 webview
 */
public class ScenesDetailWebActivity extends Activity {

	@ViewInject(R.id.webView_show_child_scene)
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.scenes_detail_web_activity);
		...
		if (type == 1) {
			...
			ToastUtils
					.showShortToast(ScenesDetailWebActivity.this, "出错了,请稍后再试");
