...
public class TzmInfoHelpActivity extends Activity{
		...
		apiClient.api(tzmInfoHelpApi, new ApiListener() {
			...
			public void onComplete(String jsonStr) {
				...
				if (base.success) {
					...
					ToastUtils.showShortToast(TzmInfoHelpActivity.this,
							base.error_msg);
				}
			}
		}, true);
	...
	private void init() {
		...
		if (tzmInfoHeplModels != null && tzmInfoHeplModels.size() > 0) {
			tv_title.setText(tzmInfoHeplModels.get(0).title);
